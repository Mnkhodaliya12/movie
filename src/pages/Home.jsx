...
function Home() {
  ...
  const heroMovie = (featuredDeal && featuredDeal.movie)
  ...
  const heroYear = heroMovie

    ? (typeof heroMovie.releaseDate === 'string' && heroMovie.releaseDate.slice(0, 4))

      || (typeof heroMovie.release_date === 'string' && heroMovie.release_date.slice(0, 4))
  ...
  const heroRating = heroMovie

    ? (typeof heroMovie.rating === 'number' && heroMovie.rating.toFixed(1))

      || (typeof heroMovie.vote_average === 'number' && heroMovie.vote_average.toFixed(1))
  ...
  const isTrendingNowTitle =

    featuredDeal &&

    typeof featuredDeal.title === 'string' &&

    featuredDeal.title.trim().toLowerCase() === 'trending now';
  ...
  return (
    ...
    <div className="mt-2 md:mt-0 space-y-8">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-700 px-6 py-8 shadow-lg md:px-10 md:py-10 mr-6 md:mr-10">
                    ...
                    <h1
                      ...
                      className={
                        ...
                        isTrendingNowTitle
                          ...
                          ? 'text-2xl font-semibold leading-tight tracking-tight text-slate-50 sm:text-3xl lg:text-4xl'

                          : 'text-3xl font-semibold leading-tight tracking-tight text-slate-50 sm:text-4xl lg:text-5xl'
